...
namespace GenericHid
{
		...
		: Form
	{
					...
					do
					{
						...
						if (!_hidHandle.IsInvalid)
						{
							...
							else
							{
                                ...
                                MyMarshalDataToForm(FormActions.AddItemToListBox, "Error in filling HIDD_ATTRIBUTES structure.");
								_deviceHandleObtained = false;
								_hidHandle.Close();
							}
						}
		...
		private async void RequestToGetInputReport() //wird nicht benutzt
		{
		...
		private async void RequestToSendOutputReport() //wird nicht benutzt
		{
